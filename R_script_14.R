...
in_vars <-subset(in_vars, in_vars$study_id %in% UNCseq_Sample_Data_hpv16_POS$sample)
...
sample_dictionary <- UNCseq_Sample_Data_hpv16_POS$study_id
names(sample_dictionary) <- UNCseq_Sample_Data_hpv16_POS$sample
...
write.fasta(out_seq, seq_names, file.out = "reference_and_sample_HPV16_genotypes_RNA_DATA.fasta", open = "w", nbchar = 60, as.string = FALSE)
